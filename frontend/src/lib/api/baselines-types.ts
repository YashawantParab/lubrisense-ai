...
export type BaselineStrategyType =
  "STATIC_ENGINEERING_REFERENCE" | "ROLLING_ASSET_BASELINE" | "CONTEXTUAL_ASSET_BASELINE";

export type BaselineMetricKind = "STANDARD" | "RESERVOIR_TREND" | "CYCLE_METRIC";

export type BaselineState =
  "INSUFFICIENT_DATA" | "BUILDING" | "ACTIVE" | "STALE" | "INVALIDATED" | "SUPERSEDED";

export type BaselineSourceKind =
  "EXACT_CONTEXT" | "OPERATING_STATE" | "SENSOR_LEVEL" | "ENGINEERING_REFERENCE" | "NONE";

export type DeviationClassification =
  "WITHIN_EXPECTED_RANGE" | "MILD_DEVIATION" | "STRONG_DEVIATION" | "NOT_ENOUGH_DATA";
